...
assert.equal(odds.title(99.95, "en-US"), "99.9%");
assert.equal(odds.title(0.012345, "en-US"), "0.0123%");
assert.equal(odds.title(12.3456, "en-US"), "12.3%");
...
assert.equal(odds.title(12.3456, "pt-BR"), "12,3%");
